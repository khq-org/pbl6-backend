...
public class StudentController {
    ...
    @GetMapping
    public Response<ListDTO<StudentDTO>> getListStudent(@ModelAttribute ListStudentRequest request) {
    ...
    @GetMapping("/{id}")
    public Response<StudentDetailDTO> getStudent(@PathVariable("id") Long studentId) {
